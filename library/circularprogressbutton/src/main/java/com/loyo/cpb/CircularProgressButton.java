...
public class CircularProgressButton extends Button {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int blue = getColor(R.color.cpb_trans_white);
            int white = getColor(R.color.cpb_clear);
            int grey = getColor(R.color.cpb_trans_black);
    ...
    private void morphProgressToComplete() {
        ...
        int clear = getColor(R.color.cpb_clear);
        animation.setToStrokeColor(clear/*getNormalColor(mCompleteColorState)*/);
    ...
    private void morphCompleteToIdle() {
        ...
        int clear = getColor(R.color.cpb_clear);
        animation.setToStrokeColor(clear/*getNormalColor(mIdleColorState)*/);

package com.loyo.oa.v2.ui.activity.home.slidingmenu;
...
public class CustomViewBehind extends ViewGroup {
	...
	public void drawSelector(View content, Canvas canvas, float openPercent) {
		...
		if (mSelectorDrawable != null && mSelectedView != null) {
			String tag = (String) mSelectedView.getTag(com.jeremyfeinstein.slidingmenu.lib.R.id.selected_view);
	...
	public void setSelectedView(View v) {
		if (mSelectedView != null) {
			mSelectedView.setTag(com.jeremyfeinstein.slidingmenu.lib.R.id.selected_view, null);
			mSelectedView = null;
		}
		if (v != null && v.getParent() != null) {
			mSelectedView = v;
			mSelectedView.setTag(com.jeremyfeinstein.slidingmenu.lib.R.id.selected_view, TAG+"SelectedView");
			invalidate();
		}
	}

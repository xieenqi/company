 ...
 */
public class FragmentNearCustomer extends BaseFragment implements PullToRefreshBase.OnRefreshListener2{
    ...
    private void bindData() {
        ...
        if (null == adapter) {
            adapter = new AdapterNearCustomer(getActivity(),mCustomers,customer_type);

...
public class FragmentTeamCustomer extends BaseFragment implements PullToRefreshBase.OnRefreshListener2{
    ...
    private AdapterTeamCustomer adapter;
    ...
    private Handler mHandler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            switch(msg.what){
                ...
                //部门筛选
                case ActivityCustomerManager.CUSTOMER_DEPT_CREEN:
    ...
    private void bindData() {
        ...
        if (null == adapter) {
            adapter = new AdapterTeamCustomer(getActivity(),mCustomers);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                intent.putExtra(ExtraAndResult.EXTRA_TYPE, ActivityCustomerManager.CUSTOMER_TEAM);
       ...
       public void onClick(View v) {
           ...
           switch (v.getId()) {
               ...
               case R.id.layout_near_customers:
                   ...
                   bundle.putInt("type", ActivityCustomerManager.NEARCUS_TEAM);//团队2 个人1

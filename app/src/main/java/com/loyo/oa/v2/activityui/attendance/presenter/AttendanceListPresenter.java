...
public class AttendanceListPresenter implements AttendanceListPresenterImpl{

    public Activity mActivity;
    public AttendanceListView crolView;

    public AttendanceListPresenter(Activity mActivity,AttendanceListView crolView){

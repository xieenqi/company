package com.loyo.oa.v2.ui.activity.wfinstance.fragment;
...
public class WfinstanceManagerFilterFragment extends Fragment implements View.OnClickListener {
    ...
    ViewGroup layout_type1, layout_type2, layout_type3, layout_status1, layout_status2, layout_status3, layout_status4, layout_status5;
    ...
    public static String MSG_WFINSTANCE_FILTER = "com.loyo.oa.v2.wfinstance.filter";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        if (view == null) {
            view = inflater.inflate(R.layout.fragment_wfinstance_manager_filter, container, false);
            ...
            layout_status4 = (ViewGroup) view.findViewById(R.id.layout_status4);
            layout_status5 = (ViewGroup) view.findViewById(R.id.layout_status5);
            ...
            layout_status4.setOnClickListener(this);
            layout_status5.setOnClickListener(this);
                ...
                lv_subordinates.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (strSearch.length() > 0) {
                            ...
                            intent.setAction(MSG_WFINSTANCE_FILTER);
...
//            status=0(全部), status=1(新建), status=2(处理中),status=3(不通过), status=4(已审批),status=5(已办结)
            ...
            case R.id.layout_status3:
                ...
                break;
            case R.id.layout_status4:
                cb7.toggle();
                status = cb7.isChecked() ? 4 : 0;
                if (cb7.isChecked()) {
                    cb4.setChecked(false);
                    cb5.setChecked(false);
                    cb6.setChecked(false);
                ...
                break;
            case R.id.layout_status5:
                cb8.toggle();
                status = cb8.isChecked() ? 5 : 0;
                if (cb8.isChecked()) {
                    cb4.setChecked(false);
                    cb5.setChecked(false);
                    cb6.setChecked(false);

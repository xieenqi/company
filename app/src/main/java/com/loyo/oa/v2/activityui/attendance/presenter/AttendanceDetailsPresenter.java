...
public class AttendanceDetailsPresenter implements AttendanceDetailsPresenterImpl{

    public AttendanceDetailsView crolView;
    public Activity mActivity;

    public AttendanceDetailsPresenter(AttendanceDetailsView crolView,Activity mActivity){

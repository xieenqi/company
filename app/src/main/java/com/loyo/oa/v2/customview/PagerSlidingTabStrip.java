 ...
 * 滑动指示器 pstsindicatorheightheight
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabTextColor = 0xFF666666;//未选择的颜色
    private int selectedTabTextColor = 0xFF666666;//选择的颜色
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        selectedTabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsUnderlineColor, indicatorColor);

...
import com.loyo.oa.v2.ui.customview.pullToRefresh.internal.AutoRoteLoadingLayout;
import com.loyo.oa.v2.ui.customview.pullToRefresh.internal.FlipLoadingLayout;
import com.loyo.oa.v2.ui.customview.pullToRefresh.internal.LoadingLayout;
import com.loyo.oa.v2.ui.customview.pullToRefresh.internal.RotateLoadingLayout;
import com.loyo.oa.v2.ui.customview.pullToRefresh.internal.Utils;
import com.loyo.oa.v2.ui.customview.pullToRefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
     ...
     */
    void smoothScrollTo(int scrollValue, long duration) {
        smoothScrollTo(scrollValue, duration, 0, null);
    }

    void smoothScrollTo(int newScrollValue, long duration, long delayMillis,
    ...
    public enum AnimationStyle {
        ...
        /**
         * This is the new for default Android-PullToRefresh. Allows you to use gif
         * drawable, which is automatically rotated and used as a Progress Bar.
         */
        AUTO_GIF;
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
            switch (this) {
                ...
                case AUTO_GIF:
                    return new AutoRoteLoadingLayout(context, mode, scrollDirection, attrs);
            }
        }
    }

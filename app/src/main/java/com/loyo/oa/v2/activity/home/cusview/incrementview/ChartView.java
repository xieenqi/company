...
public abstract class ChartView extends RelativeLayout {
     ...
     *
     * @param - Index of set to be updated
     * @param - Array of new values. Array length must match current data.
     */
     ...
     * @param -       false if the tooltip should not be forced to be inside
...
//					getResources().getDimension(R.dimen.axis_thickness));
            axisThickness = attrs.getDimension(
                    R.styleable.ChartAttrs_chart_axisThickness, 2);
...
//					getResources().getDimension(R.dimen.font_size));
            fontSize = attrs.getDimension(
                    R.styleable.ChartAttrs_chart_fontSize, 10);

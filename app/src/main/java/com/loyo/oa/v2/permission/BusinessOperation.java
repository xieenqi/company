...
public class BusinessOperation {
    ...
    @StringDef({
            DEFAULT,
            ANNOUNCEMENT, PROJECT_MANAGEMENT, TASK, WORK_REPORT, APPROVAL_PROCESS, CUSTOMER_MANAGEMENT,
            ATTENDANCE_MANAGEMENT, LOCATION_TRACKING, ORGANIZATION_CONTACTS, SALE_OPPORTUNITY,
            ORDER_MANAGEMENT, CLUE_MANAGEMENT, WORKSHEET_MANAGEMENT, CUSTOMER_VISIT, VISIT_TIMELINE,
            PROJECT_CREATING, ANNOUNCEMENT_POSTING, CUSTOMER_DUMPING, CUSTOMER_PICKING, CUSTOMER_DELETING, CLUE_DELETING})

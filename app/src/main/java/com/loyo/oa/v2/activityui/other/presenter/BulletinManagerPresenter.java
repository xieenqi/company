...
public class BulletinManagerPresenter implements BulletinManagerPresenterImpl {
    ...
    public BulletinManagerPresenter(BulletinManagerView crolView, Context mContext, Activity mActivity){

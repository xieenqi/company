...
public class BarChartView extends ChartView {
     ...
     *               parsed screen points ready to be used/drawn.
     */
    @Override
    ...
    public class Style {
        ...
        protected Style() {
            ...
            barSpacing = 6;//(float) getResources().getDimension(R.dimen.bar_spacing);
            mSetSpacing = 3;// (float) getResources().getDimension(R.dimen.set_spacing);

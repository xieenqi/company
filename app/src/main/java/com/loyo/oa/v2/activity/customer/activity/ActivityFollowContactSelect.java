 ...
 */
public class ActivityFollowContactSelect extends BaseActivity {
    ...
    class AdapterCustomerContact extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if (null == convertView) {
                convertView = LayoutInflater.from(ActivityFollowContactSelect.this).inflate(R.layout.item_sale_stage, null);
            }

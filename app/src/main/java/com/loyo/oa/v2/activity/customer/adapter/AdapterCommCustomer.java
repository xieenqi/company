 ...
 */
public class AdapterCommCustomer extends BaseAdapter{
    ...
    public AdapterCommCustomer(final Context context, ArrayList<Customer> customers,Permission permission,Handler mHandler){
            ...
            public void onClick(View v) {//挑入公海客户
                RestAdapterFactory.getInstance().build(Config_project.API_URL_CUSTOMER()).
                    ...
                    public void success(Customer customer, Response response) {
                        ...
                        mHandler.sendEmptyMessage(ActivityCustomerManager.CUSTOMER_COMM_RUSH);
                    }

 ...
 */
public class ActivityCustomerManager extends BaseFragmentActivity implements View.OnClickListener {
    ...
    private void cloneMdata(ArrayList<Tag> tags) throws IOException, ClassNotFoundException {
        ...
        mTags1 = (ArrayList<com.loyo.oa.v2.beans.Tag>) Utils.deepCopyT(mTags);
        mTags2 = (ArrayList<com.loyo.oa.v2.beans.Tag>) Utils.deepCopyT(mTags);
        mTags3 = (ArrayList<com.loyo.oa.v2.beans.Tag>) Utils.deepCopyT(mTags);
    }
    ...
    private void initChildren() {
        for (int i = 0; i < SaleItemStatus.length; i++) {
            ...
            if ("我的客户".equals(SaleItemStatus[i])) {
                ...
                b.putSerializable("permission", permission);
                fragment = (BaseFragment) Fragment.instantiate(this, FragmentCommCustomer.class.getName(), b);
            }

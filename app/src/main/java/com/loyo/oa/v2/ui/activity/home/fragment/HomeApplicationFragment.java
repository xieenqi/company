...
import com.loyo.oa.v2.ui.activity.other.BulletinManagerActivity_;
...
import com.loyo.oa.v2.ui.activity.discuss.MyDiscussActivity;
...
import com.loyo.oa.v2.ui.activity.home.cusview.MoreWindowCase;
import com.loyo.oa.v2.ui.activity.project.ProjectManageActivity_;
...
import com.loyo.oa.v2.ui.activity.signin.SignInManagerActivity_;
import com.loyo.oa.v2.ui.activity.tasks.TasksAddActivity_;
import com.loyo.oa.v2.ui.activity.tasks.TasksManageActivity_;
import com.loyo.oa.v2.ui.activity.wfinstance.WfInstanceManageActivity;
...
import com.loyo.oa.v2.ui.activity.work.WorkReportsManageActivity;
 ...
 * 【首页应用】fragment
 */
public class HomeApplicationFragment extends Fragment implements LocationUtilGD.AfterLocation,PullToRefreshBase.OnRefreshListener2{
    ...
    void updateUser() {
        ...
        items = new ArrayList<>(Arrays.asList(new HomeItem(R.drawable.newmain_toast, "公告通知", BulletinManagerActivity_.class, "0", 0),
                new HomeItem(R.drawable.newmain_discuss, "我的讨论", MyDiscussActivity.class, "0", 0),
                new HomeItem(R.drawable.newmain_list, "通讯录", ContactsActivity.class, "0213", 0),
                new HomeItem(R.drawable.newmain_customer, "客户管理", CustomerManagerActivity.class, "0205", 1),
                new HomeItem(R.drawable.newmain_sale, "销售机会", SaleOpportunitiesManagerActivity.class, "0215", 1),

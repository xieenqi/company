...
//        //此处缓存首页数据
    ...
    void updateUser() {
        ...
        items = new ArrayList<>(Arrays.asList(new HomeItem(R.drawable.newmain_toast, "公告通知", "com.loyo.oa.v2.ui.activity.other.BulletinManagerActivity_", "0", 0),
                ...
                new HomeItem(R.drawable.newmain_task, "任务计划", "com.loyo.oa.v2.ui.activity.tasks.TasksManageActivity_", "0202", 2),
                new HomeItem(R.drawable.newmain_report, "工作报告", "com.loyo.oa.v2.ui.activity.work.WorkReportsManageActivity", "0203", 2),
                new HomeItem(R.drawable.newmain_wfin, "审批流程", "com.loyo.oa.v2.ui.activity.wfinstance.WfInstanceManageActivity", "0204", 2),
                new HomeItem(R.drawable.newmain_attent, "考勤管理", "com.loyo.oa.v2.ui.activity.attendance.AttendanceActivity_", "0211", 2)));

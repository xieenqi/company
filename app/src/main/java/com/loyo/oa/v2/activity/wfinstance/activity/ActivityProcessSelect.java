 ...
 */
public class ActivityProcessSelect extends BaseActivity {
    ...
    private void intBizForm() {
        ...
        RestAdapterFactory.getInstance().build(Config_project.API_URL()).create(IWfInstance.class).getWfTemplate(mBizForm.getId(), new RCallback<ArrayList<WfTemplate>>() {
            ...
            public void success(final ArrayList<WfTemplate> bizFormFieldsPaginationX, final Response response) {
                ...
                final ProcessChooseAdapter adapter=new ProcessChooseAdapter(ActivityProcessSelect.this,bizFormFieldsPaginationX);
        ...
        public void onClick(final View v) {
            switch (v.getId()) {
                case R.id.img_title_left:
                    app.finishActivity(ActivityProcessSelect.this, MainApp.ENTER_TYPE_LEFT, RESULT_CANCELED, null);
                    break;

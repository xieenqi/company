 ...
 */
public class FragmentCommCustomer extends BaseFragment implements PullToRefreshBase.OnRefreshListener2{
    ...
    private AdapterCommCustomer adapter;
    ...
    private void bindData() {
        ...
        if (null == adapter) {
            adapter = new AdapterCommCustomer(getActivity(),mCustomers,permission,mHandler);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                intent.putExtra(ExtraAndResult.EXTRA_TYPE, ActivityCustomerManager.CUSTOMER_COMM);

/**
 *
 * new LoyoToastDialog.Build(this)
        .setTitle("Başlık")
...
import com.loyo.oa.hud.toast.utils.UtilsLibrary;
...
public class LoyoToastDialog {
    ...
    protected LoyoToastDialog(Build build) {
        mBuild = build;
            ...
            vPositive.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (build.btn_positive_callback != null)
                        build.btn_positive_callback.onClick(LoyoToastDialog.this);
            ...
            vNegative.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (build.btn_negative_callback != null)
                        build.btn_negative_callback.onClick(LoyoToastDialog.this);
                    if (build.isAutoDismiss)
                        bottomDialog.dismiss();
                }
            });
    ...
    public static class Build {
        ...
        @UiThread
        public LoyoToastDialog build() {
            return new LoyoToastDialog(this);
        }

        @UiThread
        public LoyoToastDialog show() {
            LoyoToastDialog bottomDialog = build();
            bottomDialog.show();
            return bottomDialog;
        }
    ...
    public interface ButtonCallback {
        ...
        void onClick(@NonNull LoyoToastDialog dialog);
    }

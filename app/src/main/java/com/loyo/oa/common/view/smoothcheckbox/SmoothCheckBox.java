...
package com.loyo.oa.common.view.smoothcheckbox;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        int tickColor = ta.getColor(R.styleable.SmoothCheckBox___scb_color_tick, COLOR_TICK);
        mAnimDuration = ta.getInt(R.styleable.SmoothCheckBox___scb_duration, DEF_ANIM_DURATION);
        mFloorColor = ta.getColor(R.styleable.SmoothCheckBox___scb_color_unchecked_stroke, COLOR_FLOOR_UNCHECKED);
        mCheckedColor = ta.getColor(R.styleable.SmoothCheckBox___scb_color_checked, COLOR_CHECKED);
        mUnCheckedColor = ta.getColor(R.styleable.SmoothCheckBox___scb_color_unchecked, COLOR_UNCHECKED);
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox___scb_stroke_width, CompatUtils.dp2px(getContext(), 0));
        ta.recycle();
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mListener != null) {
                    mListener.onClick(SmoothCheckBox.this);
                }
            }
        });
    }
    ...
    public interface OnCheckedChangeListener {
        ...
        void onClick(SmoothCheckBox checkBox);
    }
}

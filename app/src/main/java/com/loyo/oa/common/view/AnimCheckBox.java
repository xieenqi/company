...
/**
 * Created by EthanGong on 2016/11/4.
 */

public class AnimCheckBox extends View{
    private final String TAG = "com.loyo.common.view.AnimCheckBox";
    ...
    private OnCheckStateChanged mOnCheckedChangeListener;
    ...
    public void setChecked(boolean checked, boolean animation){
        ...
        if (mOnCheckedChangeListener != null){
            mOnCheckedChangeListener.onCheckStateChanged(mChecked);
        }
    }
     ...
     */
    public void setStateChangeListener(OnCheckStateChanged listener) {

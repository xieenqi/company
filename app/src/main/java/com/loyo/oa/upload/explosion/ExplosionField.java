...
public class ExplosionField extends View{
    ...
    public void explode(final View view) {
        ...
        rect.offset(0, -Utils.dp2px(getContext(), 20-view.getPaddingTop()));
    ...
    public void explode(final View view, final ExplosionListener listener) {
        Rect rect = new Rect();
        view.getGlobalVisibleRect(rect);
        rect.offset(0, -Utils.dp2px(getContext(), 20-view.getPaddingTop()));
